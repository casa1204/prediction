"""LightGBM 예측 모델 — LightGBM 기반 모델 구현.

XGBoostModel과 동일한 구조로 BaseModel을 상속한다.
"""
...
class LightGBMModel(BaseModel):
    ...
    def train(self, X: np.ndarray, y: np.ndarray) -> None:
        ...
        logger.info("LightGBM 모델 학습 완료: %d 샘플, %d 피처", len(X), X.shape[1])
